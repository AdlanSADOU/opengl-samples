...
static inline vec3_t v3_norm(vec3_t v)
{
    ...
    vec3_t greater = {v.x / len, v.y / len, v.z / len};
    vec3_t lesser  = {0, 0, 0};
    if (len > 0)
        return greater;
    else
